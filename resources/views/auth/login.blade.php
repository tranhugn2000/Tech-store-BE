...
@section('content')
<div class="flex items-center min-h-screen p-6 bg-red-100 dark:bg-gray-900">
    <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex flex-col overflow-y-auto md:flex-row">
            <div class="h-32 md:h-auto md:w-1/2">
                <img aria-hidden="true" class="object-cover w-full h-full dark:hidden" src="/images/loginImage/login.jpg" alt="Office" />
                ...
                <div class="w-full">
                    ...
                    <form action="{{ route('doLogin') }}" method="POST">
                        ...
                        <label class="block text-sm">
                            ...
                            <input id="email" name="email"class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="email" />
                            @error('email')
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            <input id="password" name="password" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="*******" type="password" />
                            @error('password')
                                <span class="help-block has-error text-red-600">{{ $message }}</span>
                            @enderror
                        </label>
